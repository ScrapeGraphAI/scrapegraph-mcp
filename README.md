...
This MCP server targets **ScrapeGraph API v2** (`https://v2-api.scrapegraphai.com/api/v2`), aligned 1:1 with
...
- **`SGAI_API_URL`** — override the base URL (default `https://v2-api.scrapegraphai.com/api/v2`)
...
- **Base URL**: `https://v2-api.scrapegraphai.com/api/v2`
